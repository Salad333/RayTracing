...
int main(int argc, char *argv[])
{
	...
	// add objects
	Scene<float> scene;
	scene.objects = { new Sphere<float>({ 0.f, -10002.f, -20.f }, 10000, { .8f, .8f, .8f }, 0.0f, 0.0f, true),
		new Sphere<float>({ 0.f, 2.f, -20.f }, 4, { .8f, .5f, .5f }, 0.5f),
		new Sphere<float>({ 5.f, 0.f, -15.f }, 2, { .3f, .8f, .8f }, 0.2f),
		new Sphere<float>({ -5.f, 0.f, -15.f }, 2, { .3f, .5f, .8f }, 0.2f),
		new Sphere<float>({ -2.f, -1.f, -10.f }, 1, { .1f, .1f, .1f }, 0.1f, 0.8f) };
